...
if __name__ == "__main__":
    ...
    parser.add_argument("--video_path", default='/home/jj/JKW/samurai/realsense_output.mp4', help="Input video path or directory of frames.")
    parser.add_argument("--txt_path", default='/home/jj/JKW/samurai/bbox', help="Path to ground truth text file.")
